...
namespace heimdall_client.Api
{
    ...
    public partial class ScopeApi : IScopeApi
    {
        ...
        /// <returns></returns>
        public ScopeApi(heimdall_client.Client.Configuration configuration)
        {
        ...
        public ScopeApi(heimdall_client.Client.ISynchronousClient client, heimdall_client.Client.IAsynchronousClient asyncClient, heimdall_client.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="scope"></param>
        /// <returns>ApiResponse of Object(void)</returns>
        public heimdall_client.Client.ApiResponse<Object> SaveScopeWithHttpInfo(Scope scope)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
            {
                throw new heimdall_client.Client.ApiException(400, "Missing required parameter 'scope' when calling ScopeApi->SaveScope");
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<heimdall_client.Client.ApiResponse<Object>> SaveScopeWithHttpInfoAsync(Scope scope, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
            {
        ...
        /// <param name="scope">Name of scope to delete</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public heimdall_client.Client.ApiResponse<Object> ScopeDeleteWithHttpInfo(string scope)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
            {
                throw new heimdall_client.Client.ApiException(400, "Missing required parameter 'scope' when calling ScopeApi->ScopeDelete");
            }
            ...
            localVarRequestOptions.PathParameters.Add("scope", heimdall_client.Client.ClientUtils.ParameterToString(scope)); // path parameter
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<heimdall_client.Client.ApiResponse<Object>> ScopeDeleteWithHttpInfoAsync(string scope, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
            {
        ...
        {
            heimdall_client.Client.ApiResponse<List<Scope>> localVarResponse = ScopesWithHttpInfo();
        ...
        /// <exception cref="heimdall_client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of List&lt;Scope&gt;</returns>
        public heimdall_client.Client.ApiResponse<List<Scope>> ScopesWithHttpInfo()
        {
            heimdall_client.Client.RequestOptions localVarRequestOptions = new heimdall_client.Client.RequestOptions();
        ...
        {
            heimdall_client.Client.ApiResponse<List<Scope>> localVarResponse = await ScopesWithHttpInfoAsync(cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;Scope&gt;)</returns>
        public async System.Threading.Tasks.Task<heimdall_client.Client.ApiResponse<List<Scope>>> ScopesWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
